    ...
    getHint(): Array<Displayable> {
        switch(this.activeStep) {
            ...
            case Step.YellowCornerStickers: return [new DisplayableHeading("Yellow Corner Orientation (6/8)"),
                                                    ...
                                                    new DisplayableText("The upper left corner is now your working space, where you orient the corner, so the yellow side faces up. There are 3 possible cases:"),
                                                    new DisplayableText("1. The corner is oriented correctly - you don't need to do anything."),
